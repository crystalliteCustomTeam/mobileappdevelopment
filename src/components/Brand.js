          ...
          <Row className={`${styles.newtsl} gy-3 gx-0`}>
            <Col lg={4}>
              <div className={styles.imgtoken}>
                <Image src={free} width={436} height={618} alt='Bitswits' loading='lazy' sizes="100vw" className="img-fluid" />
              </div>
            </Col>
            <Col lg={8}>
              <div className={styles.level}>
                ...
                <form className={styles.your} onSubmit={handleSubmit}>
                  <div>
                    ...
                    <div className={styles.chill}>
                      <button type='submit' className='pink bitsForm' disabled={isDisabled}>{score}</button>
                    </div>
                  </div>
                </form>
              </div>
