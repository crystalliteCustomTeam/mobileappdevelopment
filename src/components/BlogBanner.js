                        ...
                        <Col lg={12}>
                            ...
                            <div className={styles.form}>
                                <form onSubmit={handleSubmit}>
                                    <input type="email" name='email' placeholder='Enter Your Email Address' required className='fontsfregular' />
                                    <button type='submit' className='fontsfregular bitsForm' disabled={isDisabled}>{score}</button>
                                </form>
                            </div>
                        </Col>
                    </Row>
